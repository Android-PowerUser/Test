...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.google.ai.sample.screenshot";
    private static final String NOTIFICATION_CHANNEL_NAME = "Screenshot Service";
    ...
    private static Notification createNotification(@NonNull Context context) {
        ...
        builder.setContentTitle("Screenshot Service");
        builder.setContentText("Capturing screen content");
