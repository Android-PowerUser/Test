    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(text = "System Message", style = MaterialTheme.typography.titleMedium, color = MaterialTheme.colorScheme.onPrimaryContainer)
        ...
        Card(
            ...
            Row(
                ...
                Column(modifier = Modifier.padding(end = 8.dp)) {
                    ...
                    IconButton(
                        onClick = {
                            Log.d("PhotoReasoningScreen", "New button clicked")
                            onClearChatHistory()
                            coroutineScope.launch {
                                Log.d("PhotoReasoningScreen", "Scrolling list state to 0")
                                listState.scrollToItem(0)
                            }
                            imageUris.clear()
                            userQuestion = ""
                        },
                        modifier = Modifier.padding(top = 4.dp).drawBehind { drawCircle(color = Color.Black, radius = size.minDimension / 2, style = androidx.compose.ui.graphics.drawscope.Stroke(width = 1.dp.toPx())) }
                ...
                IconButton(
                    onClick = {
                        if (userQuestion.isNotBlank() || imageUris.isNotEmpty()) {
            ...
            if (imageUris.isNotEmpty()) {
                LazyRow(modifier = Modifier.padding(start = 8.dp, end = 8.dp, bottom = 8.dp)) {
                    items(imageUris) { imageUri -> AsyncImage(model = imageUri, contentDescription = null, modifier = Modifier.padding(4.dp).requiredSize(72.dp)) }
                }
            }
        }
